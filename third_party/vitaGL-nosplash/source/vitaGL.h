...
// Waits for GXM and immediately releases objects queued by glDelete*.
// Intended for large scene transitions that must reclaim memory before the
// next frame/swap is reached.
