...
// Request an explicit GPU completion barrier for the next surface read. This
// is only needed by the Chapter 2 MD5 puzzle on Vita; glReadPixels itself is
// synchronous for ordinary surface consumers.
